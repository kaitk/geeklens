...
export const instructionCategories = {
  'Vector & general SIMD Extensions': {
    description:
      'SIMD (Single Instruction, Multiple Data) instructions for parallel processing. Modern ones uses blue color tones.',
    instructions: {
  ...
  'Matrix & AI Accelerators': {
    description:
      'Specialized instructions for matrix operations and machine learning use amber/orange tones. Instructions sharing other SIMD registers use blue',
    instructions: {
  ...
  Other: {
    description:
      'Other extensions not listed above use gray color tones. These are usually not used to accelerate workloads.',
    instructions: {},
  },
};
